...
Route::prefix('user')->controller(App\Http\Controllers\Api\Auth\UserAuthController::class)->middleware('checkLang')->group(function () {
    Route::post('users/login', [App\Http\Controllers\Api\Auth\UserAuthController::class,'login'])->middleware("throttle:test");
    Route::post('users/register', [App\Http\Controllers\Api\Auth\UserAuthController::class,'register']);
    Route::post('users/logout',[App\Http\Controllers\Api\Auth\UserAuthController::class, 'logout']);
    Route::post('users/checkcode', [App\Http\Controllers\Api\Auth\UserAuthController::class,'checkcode'])->middleware("throttle:test");
    ...
    Route::post('users/profile/change-password',[App\Http\Controllers\Api\Auth\UserAuthController::class,'change_password']);
    Route::get('user/getUserData',[AuthController::class,'getUserData']);
    Route::post('users/profile/update-profile',[App\Http\Controllers\Api\Auth\UserAuthController::class,'update_profile']);

    Route::post('users/password/email',  [App\Http\Controllers\Api\Auth\UserAuthController::class,'forget'])->middleware("throttle:forgot");
    Route::post('users/password/code/check', [App\Http\Controllers\Api\Auth\UserAuthController::class,'code'])->middleware("throttle:forgot");
