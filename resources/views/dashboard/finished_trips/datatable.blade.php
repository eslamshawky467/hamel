      ...
      $(function () {
        var table = $('.yajra-datatable').DataTable({
           ...
           "oPaginate": {
            ...
            ajax: "{{ route('finished.list') }}",
            columns: [
                {data:'client', name:'clients.name', searchable: true},
                {data:'phonenumber', name:'clients.phonenumber', searchable: true},
                {data:'email', name:'clients.email', searchable: true},
                {data:'id_number', name:'clients.id_number', searchable: true},
                {data:'location', name:'location'},
       
                {data:'is_transfered', name:'is_transfered'},
                {data:'price', name:'price'},
                {data:'to_location', name:'to_location'},
                {data:'action', name:'trip_status'},
