                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-form"> {{ __('dash.create_qa') }} </h4>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <form class="form"
                                    ...
                                    <div class="form-body">
                                        <h4 class="form-section"><i class="ft-home"></i>{{ __('dash.qa') }} </h4>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title_ar" placeholder="Arabic Title" autofocus class="form-control" value="{{ old('title_ar') }}" required>
                                                    @error("title_ar")
