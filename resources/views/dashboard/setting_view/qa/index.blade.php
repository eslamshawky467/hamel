@extends('dashboard.setting_view.qa.datatable')
@section('title')
    {{ __('dash.qa') }}
@endsection
@section('content')
            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('qa.create')}}">{{trans('dash.create_qa') }}</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                           <a class="btn btn-success" href="{{route('qa.create')}}">{{trans('dash.create_qa') }}</a>
