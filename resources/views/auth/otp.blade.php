...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <h1>Welcome Humel App</h1>
        </div>
        <div class="alert alert-danger">
            <h2>We have received your request to Login </h2>
            <p>You can use the following code to Login with  your account:</p>
            <h1 style="color:red">The allowed duration of the code is 5 minute from the time the message was sent</h1>
        </div>
